    ...
    <div class="container-fluid text-center border-bottom">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-4 nombre-apellido">
                <?php echo $user['Nombres']; ?> <?php echo $user['AP']; ?> <?php echo $user['AM']; ?>
                <p class="texto-abajo">RFC: <?php echo $user['RFC']; ?></p>
                <p class="texto-abajo"><?php echo $user['Calle']; ?> No.<?php echo $user['NumExt']; ?> <?php if(!empty($user['NumInt'])){ echo " #". $user['NumInt']; } ?> </p>
                <p class="texto-abajo">Col.<?php echo $user['Colonia']; ?></p>
                <p class="texto-abajo"><?php echo $user['Municipio']; ?></p>
                <p class="texto-abajo">C.P.<?php echo $user['CP']; ?>, <?php echo $user['Estado']; ?> </p>
            </div>
            <div class="col col-divider barras">
                Realiza tu pago escaneando este código
                <img src="https://www.consumoteca.com/wp-content/uploads/codigo-de-barras.png" class="img-fluid" width="180.234375" height="130.078125" alt="...">
            </div>
            <div class="col col-divider QR">
                Paga fácilmente con IZZI app
                <p><img src="https://es.mailpro.com/blog/image.axd?picture=/QRCODES.png" class="img-fluid" width="130" height="130" alt="..."></p>
            </div>
        </div>
    </div >
